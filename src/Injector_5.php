...
/**
 * @class PDI\Injector
 * @requires PHP >= 4.0 (compulsory), composer (optional), PHPUnit (optional)
 *
 * use the Injector.php script instead if you have PHP >= 7.0 installed
 *
 ...
 */
	...
	*/
	class Injector extends \Autoloader
	{
		...
		*/
		public function __construct($default_autoloader = false, $namespace_locations = array())
		{
		...
		*/
		 ...
		 *
		 * @param $object_name, String. As the name implies, it returns name of the object to get.
		 * @return string;
		 * @access public
		 *
		...
		*/
		public function __set($object_name, $object_value)
		{
		...
		*/
		 ...
		 * @access private
		*/
		private function useDefaultAutoloader()
		{
